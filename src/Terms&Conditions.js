...
export default function Terms_conditons(){
    return <section>
        <p><strong>Terms and Conditions</strong></p>
        <p>Our Terms and Conditions were last updated on [8th.January 2022].</p>
        ...
        <li>
        <p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to [Trafalgar Enterprises].</p>
        </li>
        <li>
        <p><strong>"Country"</strong> refers to [England].</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>"Website"</strong> refers to [TrafalgarEnterprises@gmail.com], accessible from [TrafalgarEnterprises.com]</p>
        </li>
        <li>
        ...
        <ul>
        <li>By visiting this page on our website: [TrafalgarEnterprises.com]</li>
        <li>By sending us an email: [TrafalgarEnterprises@gmail.com]</li>
        </ul>
        <p></p>
</section>
}